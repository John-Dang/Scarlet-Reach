...
/datum/species/dullahan
	...
	These are living elves, humans and tieflings, whose souls are in the brain instead of the heart; the \
	heart still beats, but Lux does not flow through it. They can remove their heads at will, which most \
	fencers and thieves use to dodge about with their vital skull to be out of an opponent’s reach. The \
	people afflicted by this condition claim they do not recall how they came to be this way, but some \
	pious souls claim these are a foul abomination, an accursed creature that masquerades as human. \
