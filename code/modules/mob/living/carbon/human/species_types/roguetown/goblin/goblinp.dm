...
/datum/species/goblinp
	...
	id = "goblinp"
	desc = "<b>Goblin</b><br>\
	Created by the hand of Noc as a creative and inquisitive species, tribes of goblins spread across \
	the world from the wind-whipped steppes of Gronn. While their worship and their culture is \
	different across the nations, a commonality is the nomadic nature of their clans across the wilds. \
	They have become a favorite of Graggar to capture and devour the souls, releasing empty violent \
	husks into the world’s cities. These well traveled peoples at times do settle down into villages or \
	join established settlements, where fast feet aid them when they are mistaken for portal-thralls. \
