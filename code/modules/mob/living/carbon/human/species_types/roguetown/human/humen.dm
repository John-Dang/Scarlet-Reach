...
/datum/species/human/northern
	...
	Found across the world they are diverse in belief and culture, yet their differences strengthen the \
	bond of this species. Even if they hail from nations historically at odds, evolutionary design urges \
	them to help another human in need. Their people are found in every continent, in the worship of \
	all the Gods, serving as a commonality. If civilization has touched any corner of the world then \
	humans have left their bootprints in the sand. They hold no dominant traits but a sense of pride.<br>\
