...
/datum/species/elf/dark
	...
	When the elves were created, some took an arrogant pride that was undue to them, some even \
	claimed themselves equal to Psydon. When he was about to unleash his wrath, the most arrogant \
	elves tapped into another plane to combat him. Thus began the first demonic incursion; between \
	the infernal armies and divine wrath, some made a pact with the demons and hid underground to \
	follow the ascendants. There the worship of the ascendants is absolute, where the brutal and \
	selfish of society are seen as virtuous, and the compassionate and gentle are seen as weak fools. \
	They are the source of the Dark Crusade, armies in darksteel plate followed by thralled undead, \
	burning surface settlements. Entire cities under Otava emptied out when their people turned on \
	the cruel lords and priests, slaughtering them to rejoin the surface after Psydon’s great sacrifice.<br>\
