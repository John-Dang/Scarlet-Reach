...
/datum/species/golem/porcelain
	...
	id = "doll"
	desc = "<b>Doll</b><br>\
	After the discovery of the dwarven golems, wizards around the world attempted to replicate the \
	miracle of the Automata to mixed results. The imperial wizards of the far east made the Doll as an \
	arcane piece of engineering leaned towards administrative and hospitality needs for a court that \
	valued beauty and civility in its servants. They were made to be elegant and intelligent, and more \
	than a few are unnerved as these quiet constructs begin to fill courts across the world as advisors \
	and clerks in various guildhouses. Some folk even suspect there is some foul conspiracy involved.<br> \
