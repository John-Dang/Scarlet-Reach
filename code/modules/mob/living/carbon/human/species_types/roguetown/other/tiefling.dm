...
/datum/species/tieberian
	...
	As great portals opened in the atolls of Etrusca’s southern isles, the kings of the city-states stood \
	in the defense of the planet; prolonged combat against demonic forces changed the people, and \
	they took on the appearance of the foul enemy as the energy infused in bones as well as the soil. \
	Understood as common people in Etrusca’s other city-states and nearby Otava, the rest of Enigma \
	tends to assume they are demonic offspring with humans. Like most Etruscans they make for fine \
	sailors, capable thinkers and hale bodied, but with a fierce independent streak against nobles. <br>\
