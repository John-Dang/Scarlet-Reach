...
/datum/species/elf/wood
	...
	Dendor wanted appreciation for his works, and he made the first race of the world, and the elves \
	looked upon the wilds and praised him. Typically living 500 years they would carefully protect his \
	sacred groves, which have become the only wilds untainted by the corruption of a sickened mind. \
	Many elves mourn Dendor but still believe he can be healed, feverishly protecting the groves and \
	keeping their locations secret. At times they leave for the cities, even siring children with humans.<br>\
