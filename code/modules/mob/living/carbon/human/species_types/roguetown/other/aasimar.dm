...
/datum/species/aasimar
	...
	id = "aasimar"
	desc = "<b>Aasimar</b><br>\
	Created by Psydon was the Divine Family, ten sibling gods who helped to create the world and \
	safeguard it from decay and destruction; and from the gods came the angels, made by the ten to \
	serve as they had for Psydon as caretakers and shepherds. Rarely an angel and mortal will create \
	life together, and these children often grow up told about the great destiny they will surely fulfill. \
	Compared to a standard human they are on average more frail and tall, and have an otherworldly \
	beauty no matter their parentage. Their very blood brings fortune, and their deaths are ill omens.<br>\
