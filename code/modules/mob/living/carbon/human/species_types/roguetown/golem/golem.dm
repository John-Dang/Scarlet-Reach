...
/datum/species/golem/metal
	...
	id = "golem"
	desc = "<b>Golem</b><br>\
	For centuries the dwarven city-states grew in number, splendor and tightly guarded secrets. Soon \
	the nations of man grew jealous and began to covet them greatly, culminating in a siege of the \
	Platinum Citadel by the Grenzelhoft Freikorps. After five months of cannonfire and siege towers, \
	the gates came open to the swinging arms of artificial men, merciless in the killing of mercenaries. \
	The secret of golems was then spread by forge-priests of Malum, a creation that requires works of \
	both engineering and magic, which must obey the instruction given on the day of its creation. \
	<br> \
