...
/datum/species/halforc
	...
	Yet when the orcish slave Graggar ascended he dominated a large swath of the species, stealing \
	them away from his creator’s control. From the steppes of Gronn to the mountains of Kazugan, the \
	orcish tribes have either scattered or been conquered and absorbed in the horde of the Ironmask. \
	Not all orcs have fallen to the corruption of Graggar, and many flee for safer lands, taking partners \
	among dwarves, elves and humans; without their clans, they often adopt their non-orcish culture.<br>\
