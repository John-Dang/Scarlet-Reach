...
/datum/species/dwarf/mountain
	...
	clothes_id = "dwarf"
	desc = "<b>Dwarf</b><br>\
	Created by the hand of Malum as the hammer that would build and forge civilization, the dwarves \
	are a people proud in the martial defense of their city-state fortresses, and their local traditions. A \
	dwarf is often stubborn and prideful, but loyal and dedicated to their personal craft. The fortresses \
	are named after their most plentiful resource and ruled by councils or kings, and engage in trade \
	with the nations of man around them. At times a fortress might develop a positive relationship with \
	those around it, with dwarves living among men or sharing their talents in the guild halls of cities.<br>\
