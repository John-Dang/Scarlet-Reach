...
/datum/species/human/halfelf
	...
	Between the elves of the hidden sacred groves or those of the undercities, and the humans of \
	Enigma, at times a bond is formed. While most species can crossbreed the odds of a healthy birth \
	or even conception remains low between two species, yet elves and humans enjoy near-perfect \
	compatibility. They are as diverse as elves and humans across the world. In the past hatred \
	against them was significant, but they are now considered as equals often in both their parental \
	cultures, yet some traditional kingdoms such as Otava still believe elves and humans should be \
	separate. They enjoy both the robust healthiness of humanity, and the keen senses of the elves.<br>\
