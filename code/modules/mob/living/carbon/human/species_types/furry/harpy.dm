...
/datum/species/harpy
	...
	id = "harpy"
	desc = "<b>Harpy</b><br>\
	Called ‘magpies’ by those distrusting or irritated, some mistake this species for a halfkin race. The \
	harpies are native to the coastal cliffs of Etrusca yet their colonies have spread to great sequoia \
	forests and the chilly tops of mountains far across the world. As their tribes developed culture and \
	discovered music, they were noticed and favored by Eora, who blessed them with divine ability. \
	\
	While they can fly with their hollow bones that leave them comparatively frail and weak, they must \
	rely on updrafts and swooping movements, aided in flight by keen eyes, wit, and a rapid speed. \
	The sight of shadows from above alerts most men, as harpies can lift and drop victims to maim \
	them; in Grenzelhoft and the Scarlet Reach harpies are not trusted, as they can fly above walls. </br> \
