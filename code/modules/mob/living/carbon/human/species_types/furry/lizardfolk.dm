...
/datum/species/lizardfolk
	...
	Native to the wetlands of the Scarlet Reach so infused with mana and crawling with undead, the \
	Zardmen are naturally suited to survive the mire and thrive in it. The bog hosts isolationist tribes \
	that do not trust softskins, violently reacting to those who encroach on their lands in skirmishes \
	with both settlers and the wardens who scout ahead. With hardened scales and an ability to take \
	punishment they are still valuable to keep around, and individual zardmen have trickled into the \
	cities with the promise of generous payments, rich foods and delicious ale from weaker cityfolk.<br> \
