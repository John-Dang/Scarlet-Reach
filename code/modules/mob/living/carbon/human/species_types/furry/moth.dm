...
/datum/species/moth
	...
	id = "moth"
	desc = "<b>Fluvian</b><br>\
	In an era long past there was a Great Library, containing the most powerful arcane tomes of the \
	world in safety from those who would abuse them. In time it was abandoned and forgotten as its \
	knights were called to service and died. But the moths of the library began to chew on the magic \
	infused pages, and changed in both body and mind. Deeply inquisitive and alien in both shape \
	and social engagement, the Fluvians skitter about the cities of man chewing old cloth and making \
	new works in tailor shops and crafter’s guild halls, they are considered highly odd by most people. <br>\
