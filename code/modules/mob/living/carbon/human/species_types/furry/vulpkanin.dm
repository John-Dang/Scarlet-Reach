...
/datum/species/vulpkanin
	...
	Created by the hand of Dendor in the earliest era, Xylix took to favor these fox-like wildkin and \
	blessed them with his creative spark. Native to the mountains and woods of Grenzelhoft, they \
	have spread across the world as explorers and poets, creating art and testing the limits of luck. \
	Looked upon some as thieves and tricksters, but their sharp minds make them useful in both the \
	guild halls and the stewardies. Some still favor Dendor and live in his wilderness, but most enjoy \
	the chance and creative spirit of the cities, especially those who have migrated to the east isles.<br>\
