...
/datum/species/anthromorphsmall
	...
	A catch-all for various races of the world, too few in number and too insignificant in deeds to be \
	remembered by the commoners of the kingdoms. They are seen as untrustworthy scavengers to \
	most citizens, seen rooting around in ancient ruins or picking over the corpses of ambushes and \
	the aftermath of large battles. Locals of the Scarlet Reach tend to associate these diminutive \
	wildkin with crime and low intelligence, but some use these low expectations to their advantage. \
	Relegated to the fringe of society in outposts, their diets are often poor in nutrition and unreliable. \
	They commonly work in the city factories yet live under-street, away from the eye of decent folk. <br> \
