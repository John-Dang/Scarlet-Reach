...
/datum/species/dracon
	...
	id = "dracon"
	desc = "<b>Drakian</b><br>\
	A sturdy dragon-like race that lives up to 250 years, it is disputed if their ancestors were \
	draconically-blessed zardmen or cursed by greed. They have been known to rise to positions of \
	leadership amongst levies and petty nobility of kingdoms, attracting followers with confidence \
	and a willingness to dirty their hands. Common in the east, they can be found across the world, \
	yet those who settle in the west find they become associated with Matthios by most commoners. \
	With war across their various homelands, at times one will rise to lead their community from the \
	front of the conflict. Some say it is bravery and leadership, others say it is delusional egotism.<br>\
