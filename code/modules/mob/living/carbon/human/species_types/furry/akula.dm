...
/datum/species/akula
	...
	id = "akula"
	desc = "<b>Axian</b><br>\
	During Psydon’s battle with Zizo, great floods threatened people on the coasts of the province of \
	Etrusca. Abyssor heard these prayers and stepped in, transforming those threatened by the flood \
	into fishy abominations. They survived the crisis, and became reliable for strength and durability. \
	They then spread across the world through trade and job contracts, anywhere the tide will go. A \
	wanderlust afflicts most Axians, they travel through ports looking for work and opportunity often. \
