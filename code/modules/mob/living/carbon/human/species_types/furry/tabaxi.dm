...
/datum/species/tabaxi
	...
	id = "tabaxi"
	desc = "<b>Tabaxi</b><br>\
		Slender and taller than a typical human, these wildkin tend to stand equally with elves, infuriating \
		dwarves with their height. Hailing first from the deep jungles of Etrusca, they have spread across \
		the world and developed spotted and striped fur of different colorations depending on the biome. \
		Blessed to be suited as athletes with a sharp sense of awareness, there is some debate on which \
		God may have shown them favor. Some say Necra guides their sight, Noc their sharp minds, Xylix \
		their curiosity and wit, yet still most of humanity would not trust them not to snatch their coinpurse; \
		some even think they were made by Matthios, that they are given to both thievery and treachery.<br>\
