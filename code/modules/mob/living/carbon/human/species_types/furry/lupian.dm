...
/datum/species/lupian
	...
	id = "lupian"
	desc = "<b>Lupian</b><br>\
	Created by Dendor’s hand in the cold of Hammerhold, the Lupians were expected to survive by \
	themselves as had his other races. But as they suffered from cold and malnutrition, intervention \
	came by the spark of Noc’s ingenuity, who taught them how to not just survive, but to even thrive. \
	These are resilient people with a knack for planning ahead, who have spread from the frozen \
	northern isles not just as raiders but as settlers, gaining a reputation above other wildkin races as \
	a civilized species. They are more at home in castles and towns than the untamed wilderness, yet \
	some still associate them with a dim animalistic nature, created as they were by Dendor’s hand.<br>\
