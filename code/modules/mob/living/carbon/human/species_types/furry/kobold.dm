...
/datum/species/kobold
	...
	id = "kobold"
	desc = "<b>Kobold</b><br>\
	Collectives of kobolds once inhabited the great mountain ranges of Gronn, these tribes safe from \
	the savage whipping winds of the plains and well defended by their terrain from mounted raiders. \
	But then came the Iron Dwarves, who besieged the mountains by justification of Malum’s will. The \
	dwarves formed the Iron Burrow, and the native tribes were made to slave in the mines for gems. \
	Many kobolds follow Matthios as their liberator, breaking chains and fleeing west for safer lands. \
	Some end up dead fleeing across the steppes of Gronn, but others make it to less cruel regimes.<br>\
